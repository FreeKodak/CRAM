...
export default class Avail extends React.Component {
        ...
        return (
            <View>
                <Calendar
                    ...
                    hideDayNames={true}
                    markedDates={{
                        '2019-12-16': { selected: true, selectedColor: '#FCBA03' },
                        '2019-12-14': { selected: true, selectedColor: '#FCBA03' },
                        '2019-12-18': { selected: true, selectedColor: '#FCBA03' },
                        '2020-01-19': { selected: true, selectedColor: '#FCBA03' }
                    }}
